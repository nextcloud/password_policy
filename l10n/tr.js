OC.L10N.register(
    ...
    "Please note, this option is meant to protect attacked accounts. Disabled accounts have to be re-enabled manually by administration. Attackers that try to guess passwords of accounts will have their IP address blocked by the bruteforce protection independent from this setting." : "Lütfen bu seçeneğin saldırıya uğrayan hesapları koruma amaçlı olduğunu unutmayın. Devre dışı hesapların yönetim tarafından el ile yeniden etkinleştirilmesi gerekir. Hesapların parolalarını bulmaya çalışan saldırganların IP adresleri bu ayardan bağımsız olarak kaba kuvvet saldırısı koruması tarafından engellenir.",
