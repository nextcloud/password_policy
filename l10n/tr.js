OC.L10N.register(
    "password_policy",
    {
    "Password is expired, please use forgot password method to reset" : "Parolanın süresi dolmuş. Lütfen sıfırlamak için parolamı unuttum yöntemini kullanın",
    ...
    "Minimum password length" : "En az parola uzunluğu",
    "User password history" : "Kullanıcının parola geçmişi",
    "Number of days until user password expires" : "Kullanıcı parolasının süresinin dolmasına kalan gün",
    "Number of login attempts before the user account is blocked (0 for no limit)" : "Kullanıcının hesabı kilitlenmeden önce yapabileceği oturum açma girişimi sayısı (sınırlama olmaması için 0 yazın)",
    ...
    "days until user password expires" : "kullanıcı parolasının süresinin dolmasına kalan gün",
    "login attempts before the user account is blocked. (0 for no limit)" : "kullanıcının hesabı kilitlenmeden önce yapabileceği oturum açma girişimi sayısı (sınırlama olmaması için 0 yazın)"
},
