OC.L10N.register(
    ...
    "Minimum password length" : "Ελάχιστο μήκος κωδικού πρόσβασης",
    "User password history" : "Ιστορικό κωδικών χρήστη",
    "Number of days until user password expires" : "Αριθμός ημερών έως τη λήξη του κωδικού πρόσβασης χρήστη",
