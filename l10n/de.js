OC.L10N.register(
    ...
    "This check creates a hash of the password and sends the first 5 characters of this hash to the haveibeenpwned.com API to retrieve a list of all hashes that start with those. Then it checks on the Nextcloud instance if the password hash is in the result set." : "Es wird ein Hash des Passwortes erstellt und die ersten 5 Zeichen dieses Hashes an haveibeenpwned.com gesendet. Danach wird eine Liste aller Hashes empfangen, welche mit den 5 Zeichen beginnen. Nextcloud prüft nun ob der Hash des eingegebenen Passwortes in der Liste der Hashes enthalten ist.",
