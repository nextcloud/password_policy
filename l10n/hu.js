OC.L10N.register(
    ...
    "General password policies" : "Általános jelszóházirend",
    "Add policy set" : "Házirendkészlet hozzáadása",
    "Login policies" : "Bejelentkezési házirendek",
    "Password history size" : "Jelszóelőzmények mérete",
    "Number of passwords to keep (securely hashed) to prevent users from reusing previously used passwords." : "A megtartandó jelszavak száma (biztonságosan hashelve), a korábban használt jelszavak újbóli használatának elkerülése érdekében.",
    "Maximum login attempts" : "Bejelentkezési kísérletek legnagyobb száma",
    "Number of login attempts before the user account will be disabled until manual action is taken. (0 for no limit)" : "A felhasználói fiók letiltása előtti bejelentkezési kísérletek száma. (0, ha nincs korlát)",
    "Please note, this option is meant to protect attacked accounts. Disabled accounts have to be re-enabled manually by administration. Attackers that try to guess passwords of accounts will have their IP address blocked by the bruteforce protection independent from this setting." : "Vegye figyelembe, hogy ez a beállítás védi a támadott fiókokat. A letiltott fiókokat kézileg engedélyezheti a rendszergazda. A jelszavakat próbálgató támadók IP-címét a nyers erős támadások elleni védelmi alkalmazás letilthatja, ettől a beállítástól függetlenül.",
    "Number of days until user password expires" : "A felhasználói jelszó lejártáig eltelt napok száma",
    "Password expiration" : "Jelszavak lejárata",
    "Warning: enabling password expiration is nowadays considered a security risk by several security agencies." : "Figyelmeztetés: a jelszavak lejáratának bekapcsolása számos biztonsági ügynökség szerint biztonsági kockázatnak tekintendő",
    "Remove policy" : "Házirend eltávolítása",
