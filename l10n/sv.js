OC.L10N.register(
    ...
    "Please note, that this option is meant to protect attacked accounts. Disabled accounts have to be re-enabled manually by administration. Attackers that try to guess passwords of accounts will have their IP address blocked by the bruteforce protection independent from this setting." : "Observera att detta alternativ är avsett att skydda attackerade konton. Inaktiverade konton måste återaktiveras manuellt av administrationen. Angripare som försöker gissa lösenord för konton kommer att få sin IP-adress blockerad av bruteforce-skyddet oberoende av denna inställning."
},
