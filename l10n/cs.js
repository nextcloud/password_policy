OC.L10N.register(
    ...
    "General password policies" : "Obecné zásady pro hesla",
    "Add policy set" : "Přidat sadu zásad",
    "Login policies" : "Zásady přihlašování",
    "Password history size" : "Hloubka historie hesla",
    "Number of passwords to keep (securely hashed) to prevent users from reusing previously used passwords." : "Počet hesel které si pamatovat (bezpečně coby jen jejich otisky) a bránit tak uživatelům v opětovném použití dřívějších hesel.",
    "Maximum login attempts" : "Nejvyšší umožněný počet pokusů o přihlášení",
    "Number of login attempts before the user account will be disabled until manual action is taken. (0 for no limit)" : "Počet pokusů o přihlášení před zablokováním uživatelského účtu (0 bez omezení)",
    "Please note, this option is meant to protect attacked accounts. Disabled accounts have to be re-enabled manually by administration. Attackers that try to guess passwords of accounts will have their IP address blocked by the bruteforce protection independent from this setting." : "Toto nastavení je určeno k ochraně napadených účtů. Zablokované účty je nutné ručně zapnout ve správě. Útočníkům snažícím se uhádnout hesla uživatelských účtů bude jejich IP adresa zablokována nezávisle na tomto nastavení.",
    "Number of days until user password expires" : "Počet dní do skončení platnosti hesla uživatele",
    "Password expiration" : "Skončení platnosti hesla",
    "Warning: enabling password expiration is nowadays considered a security risk by several security agencies." : "Varování: zapnutí omezení délky platnosti hesla je v současnosti už považováno za bezpečnostní riziko a to hned několika bezpečnostními agenturami.",
    "Remove policy" : "Odebrat zásadu",
    ...
    "Account password policies" : "Zásady ohledně hesel k účtům",
    "Share password policies" : "Zásady ohledně hesel ke sdílením"
},
