OC.L10N.register(
    ...
    "Password is among the 1,000,000 most common ones. Please make it unique." : "كلمة المرور هذه ضمن الـ 1,000,000 كلمة الأكثر شيوعاً. رجاءً، إجعلها مُميّزة.",
    ...
    "Allows admins to configure a password policy" : "تمكين المشرفين من تهيئة سياسة كلمات المرور",
    "Allow admin to define certain pre-conditions for password, e.g. enforce a minimum length" : "تمكين المشرفين من تعريف شروط مسبقة معينة لكلمة المرور. مثلاً: فرض حد أدنى من الحروف للكلمة",
