OC.L10N.register(
    ...
    "General password policies" : "Opće politike zaporki",
    "Add policy set" : "Dodaj skup pravila",
    "Login policies" : "Pravila prijave",
    "Password history size" : "Veličina povijesti zaporki",
    "Number of passwords to keep (securely hashed) to prevent users from reusing previously used passwords." : "Broj zaporki koje se zadržavaju (sigurno sažete) kako bi se spriječilo ponovno korištenje prethodno korištenih zaporki.",
    "Maximum login attempts" : "Maksimalan broj pokušaja prijave",
    "Number of login attempts before the user account will be disabled until manual action is taken. (0 for no limit)" : "Broj pokušaja prijave nakon kojih će korisnički račun biti onemogućen dok se ne poduzme ručna radnja. (0 za bez ograničenja)",
    "Please note, this option is meant to protect attacked accounts. Disabled accounts have to be re-enabled manually by administration. Attackers that try to guess passwords of accounts will have their IP address blocked by the bruteforce protection independent from this setting." : "Napomena: ova je opcija namijenjena zaštiti napadnutih računa. Onemogućene račune administrator mora ručno ponovno omogućiti. Napadačima koji pokušavaju pogađati zaporke računa IP adresa će biti blokirana zaštitom od brute-force napada neovisno o ovoj postavci.",
    "Number of days until user password expires" : "Broj dana do isteka zaporke",
    "Password expiration" : "Istek zaporke",
    "Warning: enabling password expiration is nowadays considered a security risk by several security agencies." : "Upozorenje: omogućavanje isteka zaporke danas se smatra sigurnosnim rizikom prema mišljenju više sigurnosnih agencija.",
    "Remove policy" : "Ukloni pravila",
    ...
    "Account password policies" : "Pravila zaporki računa",
    "Share password policies" : "Pravila zaporki za dijeljenja"
},
