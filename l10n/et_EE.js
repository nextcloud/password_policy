OC.L10N.register(
    ...
    "General password policies" : "Üldised paroolinõuded",
    "Add policy set" : "Lisa nõue",
    "Login policies" : "Sisselogimise nõuded",
    "Password history size" : "Paroolide ajaloo pikkus",
    "Number of passwords to keep (securely hashed) to prevent users from reusing previously used passwords." : "Paroolide arv, mida säilitada (turvaliselt räsitud), et kasutajad ei saaks varem kasutatud paroole uuesti kasutada.",
    ...
    "Please note, this option is meant to protect attacked accounts. Disabled accounts have to be re-enabled manually by administration. Attackers that try to guess passwords of accounts will have their IP address blocked by the bruteforce protection independent from this setting." : "Pane tähele, et see valik on mõeldud rünnatud kontode kaitsmiseks. Keelatud kontod peab administraator käsitsi uuesti lubama. Ründajad, kes üritavad ära arvata kontode paroole, blokeerib enda IP-aadressi jõhkruse kaitsega, sõltumata sellest sättest.",
    "Number of days until user password expires" : "Päevade arv parooli aegumiseni",
    "Password expiration" : "Parooli aegumine",
    "Warning: enabling password expiration is nowadays considered a security risk by several security agencies." : "Hoiatus: parooli aegumise lubamist peavad tänapäeval mitmed turvaasutused turvariskiks.",
    "Remove policy" : "Eemalda nõue",
    ...
    "Account password policies" : "Konto paroolinõuded",
    "Share password policies" : "Jaga paroolinõudeid",
