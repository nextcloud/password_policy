OC.L10N.register(
    ...
    "General password policies" : "Políticas gerais de senhas",
    "Add policy set" : "Adicionar conjunto de políticas",
    "Login policies" : "Políticas de login",
    "Password history size" : "Tamanho do histórico de senhas",
    "Number of passwords to keep (securely hashed) to prevent users from reusing previously used passwords." : "Número de senhas a serem mantidas (com hash seguro) para evitar que os usuários reutilizem senhas usadas anteriormente.",
    "Maximum login attempts" : "Máximo de tentativas de login",
    ...
    "Password expiration" : "Expiração da senha",
    ...
    "Account password policies" : "Políticas de senha da conta",
    "Share password policies" : "Compartilhar políticas de senha",
