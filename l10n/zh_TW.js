OC.L10N.register(
    ...
    "Password need to be at least %s characters long" : "密碼必須長於%s",
    "Password need to contain at least one lower case character and one upper case character." : "密碼應包含最少一個大寫與一個小寫。",
    "Password need to contain at least one numeric character." : "密碼需要包含至少一個數字。",
    "Password need to contain at least one special character." : "密碼應包含一個特殊符號。",
    "Password is within the 1,000,000 most common passwords. Please choose another one." : "密碼不能超過1000000個字元。"
},
"nplurals=1; plural=0;");
