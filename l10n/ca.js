OC.L10N.register(
    ...
    "General password policies" : "Polítiques generals de contrasenyes",
    "Add policy set" : "Afegeix un conjunt de polítiques",
    "Login policies" : "Polítiques d'inici de sessió",
    "Password history size" : "Mida de l'historial de contrasenyes",
    "Number of passwords to keep (securely hashed) to prevent users from reusing previously used passwords." : "Nombre de contrasenyes a conservar (hash de forma segura) per evitar que els usuaris reutilitzin les contrasenyes utilitzades anteriorment.",
    "Maximum login attempts" : "Màxim intents d'inici de sessió",
    ...
    "Please note, this option is meant to protect attacked accounts. Disabled accounts have to be re-enabled manually by administration. Attackers that try to guess passwords of accounts will have their IP address blocked by the bruteforce protection independent from this setting." : "Tingueu en compte que aquesta opció està destinada a protegir els comptes atacats. Els comptes desactivats s'han de tornar a habilitar manualment per l'administració. Els atacants que intentin endevinar les contrasenyes dels comptes tindran la seva adreça IP bloquejada per la protecció de força bruta independentment d'aquesta configuració.",
    ...
    "Warning: enabling password expiration is nowadays considered a security risk by several security agencies." : "Avís: habilitar la caducitat de la contrasenya es considera avui dia un risc per a la seguretat per part de diverses agències de seguretat.",
    "Remove policy" : "Elimina la política",
