OC.L10N.register(
    ...
    "General password policies" : "Criteri generali sulle password",
    "Add policy set" : "Aggiungi set di policy",
    "Login policies" : "Politiche di accesso",
    "Password history size" : "Dimensione cronologia password",
    "Number of passwords to keep (securely hashed) to prevent users from reusing previously used passwords." : "Numero di password da conservare (sottoposte a hash sicuro) per impedire agli utenti di riutilizzare password già utilizzate in precedenza.",
    "Maximum login attempts" : "Numero massimo di tentativi di accesso",
    ...
    "Password expiration" : "Scadenza  password",
    ...
    "Check password against the list of breached passwords from haveibeenpwned.com" : "Verifica la password con l'elenco di password compromesse di haveibeenpwned.com",
    ...
    "Account password policies" : "Criteri per le password degli account",
    "Share password policies" : "Condividi le policy sulle password"
},
