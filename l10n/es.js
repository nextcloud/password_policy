OC.L10N.register(
    ...
    "General password policies" : "Políticas generales de contraseñas",
    "Add policy set" : "Añadir conjunto de políticas",
    "Login policies" : "Políticas de inicio de sesión",
    "Password history size" : "Tamaño del historial de contraseñas",
    "Number of passwords to keep (securely hashed) to prevent users from reusing previously used passwords." : "Número de contraseñas a almacenar (mediante un hash seguro) para evitar que los usuarios reutilicen contraseñas previamente utilizadas.",
    "Maximum login attempts" : "Número máximo de intentos de inicio de sesión",
    ...
    "Password expiration" : "Caducidad de las contraseñas",
    ...
    "Account password policies" : "Políticas de contraseña de las cuentas",
    "Share password policies" : "Políticas de contraseña de los recursos compartidos"
},
