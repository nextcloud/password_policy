OC.L10N.register(
    ...
    "Number of days until user password expires" : "Número de días hasta que la contraseña expire",
    "Number of login attempts before the user account is blocked (0 for no limit)" : "Número de intentos de entrada antes de que la cuenta de usuario se bloquee (0 para que no haya límite)",
    ...
    "days until user password expires" : "días hasta que caduque la contraseña",
    "login attempts before the user account is blocked. (0 for no limit)" : "intentos de inicio de sesión antes de que el usuario sea bloqueado. (0 sin límite)"
},
