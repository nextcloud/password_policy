...
* This repository ([Password policy](https://github.com/nextcloud/password_policy/issues)) is *only* for issues within the Password policy code.
...
[template]: https://raw.github.com/nextcloud/password_policy/master/.github/issue_template.md
