...
use OCA\Password_Policy\Listener\GenerateSecureSharePasswordEventListener;
...
use OCA\Password_Policy\Listener\ValidateSharePasswordPolicyEventListener;
...
class Application extends App implements IBootstrap {
	...
	public function register(IRegistrationContext $context): void {
		...
		$context->registerEventListener(ValidateSharePasswordPolicyEvent::class, ValidateSharePasswordPolicyEventListener::class);
		$context->registerEventListener(GenerateSecurePasswordEvent::class, GenerateSecurePasswordEventListener::class);
		$context->registerEventListener(GenerateSecureSharePasswordEvent::class, GenerateSecureSharePasswordEventListener::class);
